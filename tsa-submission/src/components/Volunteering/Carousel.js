...
export function CardsCarousel({ date, pastEvents, username, profile }) {
  ...
  let data = [
    ...
    },
    {
      ...
      time: "Wed, March 31 at 1 PM - 4 PM",
      usersTask:
...

    {
      ...
      maxSpots: 9,
      address: "222 Lake Drive, Newark, DE 19702",
      time: "Thu, March 18 at 4 PM - 6 PM",
      usersTask:
...

    {
      ...
      time: "Mon, March 22 at 9 AM - 12 PM",
      usersTask:
...

    {
      ...
      maxSpots: 6,
      address: "102 Delaware Veterans Boulevard, Milford, DE, USA",
      time: "Fri, March 19 at 8:45 AM - 12 PM",
      usersTask:
...

    {
      ...
      time: "Thu, March 2 at 12 PM - 3 PM",
      usersTask:
